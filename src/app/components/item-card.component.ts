    ...
    <div class="bg-white rounded shadow p-4 flex flex-col gap-2 h-full">
      ...
      @if (!isFavorite()) {
        <button (click)="addToFavorites()"
          class="mt-2 bg-primary text-white px-4 py-2 rounded-md shadow w-full flex justify-center items-center border-2 border-transparent transition duration-150 cursor-pointer hover:ring-2 hover:ring-primary hover:ring-offset-2 hover:ring-offset-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
        ...
        <button (click)="removeFromFavorites()"
          class="mt-2 bg-secondary text-white px-4 py-2 rounded-md shadow w-full flex justify-center items-center border-2 border-transparent transition duration-150 cursor-pointer hover:ring-2 hover:ring-secondary hover:ring-offset-2 hover:ring-offset-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary">
          <span class="inline-flex items-center gap-2 justify-center w-full">
