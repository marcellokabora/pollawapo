    ...
    <div class="bg-white rounded shadow p-4 flex flex-col gap-2 h-full">
      ...
      @if (!isFavorite()) {
        <button (click)="addToFavorites()"
          class="mt-2 bg-brand text-white px-4 py-2 rounded-md shadow w-full flex justify-center items-center border-2 border-transparent transition duration-150 cursor-pointer hover:ring-2 hover:ring-brand hover:ring-offset-2 hover:ring-offset-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand">
        ...
        <button (click)="removeFromFavorites()"
          class="mt-2 bg-pink-500 text-white px-4 py-2 rounded-md shadow w-full flex justify-center items-center border-2 border-transparent transition duration-150 cursor-pointer hover:ring-2 hover:ring-pink-500 hover:ring-offset-2 hover:ring-offset-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-500">
          <span class="inline-flex items-center gap-2 justify-center w-full">
